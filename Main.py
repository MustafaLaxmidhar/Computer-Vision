    ...
    for root, dirs, files in os.walk(folder_path):
        for file_name in files:
            ...
            with open(file, 'r') as file:
                ...
                output1 = os.path.join(interim_folder, interim_image + "_B_InterimResult1.jpg")
                cv2.imwrite(output1, interim1)
                output2 = os.path.join(interim_folder, interim_image + "_B_InterimResult2.jpg")
                cv2.imwrite(output2, interim2)
                output = os.path.join(interim_folder, interim_image + "_A_WeldGapPosition.jpg")
